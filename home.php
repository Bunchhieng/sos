...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="img/front1.jpeg" alt="First slide">
        </div>
        <div class="item">
            <img src="img/For%20Donor%20Page.JPG.jpeg" alt="Second slide">
            <div class="carousel-caption">Thanks to our donors!</div>
        </div>
        <div class="item">
            <img src="img/front2.jpeg" alt="Third slide">
            <div class="carousel-caption">Thanks to our donors!</div>
        </div>
        <div class="item">
            <img src="img/quiche_and_vegetables%20(1).jpg" alt="Fourth slide">
            <div class="carousel-caption">Donate a meal</div>
        </div>
        <div class="caption">
            <h1>Enabling students to overcome the hunger barrier to collegiate success.</h1>
        </div>
    </div>
